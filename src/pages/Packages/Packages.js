...
const Packages = () => {
    ...
    return (
        <div className=''>
            ...
            <div className='grid lg:grid-cols-2 grid-cols-1  lg:mx-4 content-center lg:gap-1  '>
                {
                    packages.map(pack =>
                        ...
                        <div
                            ...
                            <div class="lg:flex lg:max-w-1/3 bg-transparent opacity-70 hover:opacity-100 bg-blue-50  rounded-lg lg:overflow-hidden">
